...
const pages = ['games', 'videos', 'metalverse', 'music'];
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Link
                ...
                href={`/${page}`}
                style={{
                  my: 2, display: 'block', borderRadius: "5px", padding: "10px",
                  color: "#FFFFFF",
            ...
            ><Stack>
                {[...pages, 'profile'].map((page) => (
                  <Link
                    key={`avatarMenu${page}`}
                    href={`${page}`}
                    style={{ borderLeft: pathname && pathname.split("/")[1] === page ? "5px solid #cbcbd4" : "none", padding: "5px" }}
